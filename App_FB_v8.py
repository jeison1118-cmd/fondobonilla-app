...
def render_igualacion_y_alta_rapida(prestamos, pagos, parametros, integrantes, aportes_tarifas, aportes_pagos):
    ...
    def _total_por_cupo_sin_inversion(prestamos_df, pagos_df, parametros_df, integ_df, aportes_pagos_df):
        # Nota: caja = capital_inicial - desembolsos + (intereses + capital_recuperado + aportes)
        # total_sin_inversion = caja + saldo_en_cartera; total_por_cupo = total_sin_inversion / cupos
        capital_inicial = 0.0
    ...
    with colEQ2:
        ...
        with st.form("form_nuevo_integrante_v8"):
            ...
            if submit_new:
                try:
                    # Si ya existe identificación, actualiza cupos y asienta igualación (sin duplicar integrante)
                    same_idx = None
    ...
    # Si no hubo cambios, devolver los mismos DataFrames
