...
# Requisitos: pip install streamlit pandas openpyxl python-dateutil gspread gspread_dataframe google-auth
...
def _gs_credentials():
    ...
    json_path = _P(__file__).with_name("service_account.json")
...
if st.sidebar.button("🗄️ Crear backup", key="side_backup"):
    dst = create_backup()
