...
# -*- coding: utf-8 -*-
# Fondo Bonilla (v8 + auth, MINIMAL SIDEBAR) — solo Login/Logout en sidebar
...
# ---------- Auth (solo login/logout en sidebar) ----------
...
# ---- Render por pestaña (igual que versión fix; omitimos barra de acciones) ----
# Panel
if sel == TABS[0]:
...
# Reportes (READER OK)
    ...
    # Métrica de rendimiento anual (igual)
    ...
    # Descarga Excel (opcional mantener)
